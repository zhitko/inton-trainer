...
DP_SETTINGS *initDpSettings()
{
    ...
    dp->multiF0Coefficient = 1.0;
    dp->multiDF0Coefficient = 1.0;
    dp->multiA0Coefficient = 1.0;
    dp->multiDA0Coefficient = 1.0;
    dp->multiNMPCoefficient = 1.0;
    dp->multiSpectrumCoefficient = 1.0;
    dp->multiCepstrumCoefficient = 1.0;
    dp->multiUseF0 = 0;
    dp->multiUseDF0 = 0;
    dp->multiUseA0 = 0;
    dp->multiUseDA0 = 0;
    dp->multiUseNMP = 0;
    dp->multiUseSpectrum = 0;
    dp->multiUseCepstrum = 1;
    dp->showPortr = 1;
    dp->portLen = 5;
    dp->umpSmoothType = 0;
    dp->umpSmoothValue = 5;
