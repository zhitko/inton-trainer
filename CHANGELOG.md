...
### Add
- Add Th rel for autosegmantation
- For autosegmentation show NMP

## [0.4.14] - 2020-01-07

### Add
- Add open reference files

## [0.4.13] - 2019-11-24

### Add
- Add user history UMPs limit setting

### Change
- Use autosegmentation if manual segmantation not available

## [0.4.12] - 2019-11-03

### Add
- Add user history UMPs
- Add user history ranges
...
### Fix
- Fix processing data free memory
...
- Add automarking minimum segment length
